...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:flex-1 bg-gradient-to-br from-brand-600 to-brand-800 items-center justify-center relative overflow-hidden">
        ...
        <div className="relative text-center text-white px-12">
          ...
          <h1 className="text-4xl font-bold mb-4">Join FoodKart</h1>
          <p className="text-brand-100 text-lg max-w-sm">
            Create your account and start ordering amazing food delivered to
            your door.
          </p>
        </div>
      </div>
